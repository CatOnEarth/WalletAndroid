...
public class Revenues extends Money {
    ...
    public Revenues(long id, double value, int type_currency, long category, int date_day, int date_month, int date_year, String description) {
        super(id, value, type_currency, category, date_day, date_month, date_year, description);
    }

    @Ignore
    public Revenues(double value, int type_currency, long category, int date_day, int date_month, int date_year, String description, long storage_location) {
